...
class ModernTheme(Theme):
    def __init__(self):
        ...
        self.text_quit_btn = "BEENDEN"
        self.text_placement_title = "KAPITÄN, POSITIONIERE DEINE FLOTTE"
        self.text_placement_instruction = "MIT R DREHEN | MIT LINKSKLICK PLATZIEREN"
        self.text_battle_player_radar = "DEINE FLOTTE"
        self.text_battle_enemy_radar = "GEGNERISCHE FLOTTE"
        self.text_airstrike_btn = "LUFTSCHLAG"
        self.text_airstrike_active = "LUFTSCHLAG AKTIV (3x3)"
        self.text_airstrike_critical = "VOLLTREFFER! SCHIFF VERSENKT!"
        self.text_airstrike_success = "TREFFER! ZIEL ERFASST!"
        self.text_airstrike_miss = "LUFTSCHLAG VERFEHLT"
        self.text_target_hit = "TREFFER!"
        self.text_target_miss = "DANEBEN."
        self.text_target_destroyed = "VOLLTREFFER! SCHIFF VERSENKT!"
        self.text_already_compromised = "DIESES FELD WURDE BEREITS ANVISIERT!"
        self.text_computer_turn = "DER GEGNER NIMMT KURS AUF DAS NÄCHSTE ZIEL..."
        self.text_game_over_win = "ALLE GEGNERISCHEN SCHIFFE ZERSTÖRT!"
        self.text_game_over_lose = "DEINE GESAMTE FLOTTE WURDE VERSENKT!"
...
class PirateTheme(Theme):
    def __init__(self):
        ...
        self.text_airstrike_active = "KANONEN BEREIT (3x3 SPERRFEUER)"
